...
define("echarts/config", [], function () {
    ...
    var t = e("./config"), n = e("./tool/env"), r = e("./tool/event"), i = e("./tool/util"), s = e("./tool/vector"), o = e("./tool/matrix"), u = t.EVENT, a = e("./mixin/Eventful"), f = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], l = {resize: function (e) {
    ...
    function h(e, t, n, s, o, u) {
        var f = s + 3 * (t - n) - e, l = 3 * (n - t * 2 + e), c = 3 * (t - e), h = e - o, p = l * l - 3 * f * c, d = l * c - 9 * f * h, v = c * c - 3 * l * h, m = 0;
        if (a(p) && a(d))if (a(l))u[0] = 0; else {
            ...
            if (a(y)) {
                ...
                var T = (2 * p * l - 3 * f * d) / (2 * Math.sqrt(p * p * p)), N = Math.acos(T) / 3, C = Math.sqrt(p), k = Math.cos(N), g = (-l - 2 * C * k) / (3 * f), w = (-l + C * (k + r * Math.sin(N))) / (3 * f), L = (-l + C * (k - r * Math.sin(N))) / (3 * f);
    ...
    function d(e, t, n, r, i, s) {
        var o = (t - e) * i + e, u = (n - t) * i + t, a = (r - n) * i + n, f = (u - o) * i + o, l = (a - u) * i + u, c = (l - f) * i + f;
    ...
    return{cubicAt: l, cubicDerivativeAt: c, cubicRootAt: h, cubicExtrema: p, cubicSubdivide: d, cubicProjectPoint: v, quadraticAt: m, quadraticDerivativeAt: g, quadraticRootAt: y, quadraticExtremum: b, quadraticProjectPoint: w}
    ...
    function _(e, t, n, r, i) {
        var s = 0, o = 0, u = 0, a = 0, f = 0, l = !0, c = n === "stroke" || n === "both", h = n === "fill" || n === "both";
        for (var p = 0; p < e.length; p++) {
            ...
            switch (d.command) {
                ...
                case"Q":
                    ...
                    break;
                case"A":
                    var w = b[0], E = b[1], S = b[2], x = b[3], T = b[4], C = b[5], k = Math.cos(T) * S + w, L = Math.sin(T) * x + E;
                    s += N(o, u, k, L);
                    var _ = (r - w) * x / S + w;
    ...
    var t = e("./util"), n = e("./curve"), r, i = {}, s = {}, o = 0, u = 0, a = 5e3, f = Math.PI * 2, C = [-1, -1, -1], k = [-1, -1];
    return{isInside: c, isOutside: d, getTextWidth: D, getTextHeight: P, isInsidePath: _, isInsidePolygon: T, isInsideSector: x, isInsideCircle: S, isInsideLine: v, isInsideRect: E, isInsideBrokenLine: b}
    ...
    return u.prototype = {constructor: u, updateNeedTransform: function () {
        ...
        var e = this.transform, t = e[0] * e[0] + e[1] * e[1], n = this.position, r = this.scale, i = this.rotation;
        o(t - 1) && (t = Math.sqrt(t));
    ...
    var t = e("../tool/matrix"), n = e("../tool/guid"), r = e("../tool/util"), i = e("../tool/log"), s = e("../mixin/Transformable"), o = e("../mixin/Eventful"), f = function (e) {
        e = e || {}, this.id = e.id || n();
    ...
    return i.prototype = {type: "image", brush: function (e, r, i) {
        var s = this.style || {};
    ...
    var t = e("./config"), n = e("./tool/util"), r = e("./tool/log"), i = e("./tool/matrix"), s = e("./loadingEffect/Base"), o = e("./mixin/Transformable"), u = window.devicePixelRatio || 1;
    u = Math.max(u, 1);
    ...
    c.prototype.render = function (e) {
        ...
        if (!t)return;
        this.modLayer(e, {position: t.position, rotation: t.rotation, scale: t.scale}), t.dom.parentNode.removeChild(t.dom), delete this._layers[e]
    ...
    return p.prototype.initContext = function () {
        ...
        var e = this.dom, t = this.ctx, n = e.width, r = e.height, i = this.clearColor && !a, s = this.motionBlur && !a, o = this.lastFrameAlpha;
    ...
    var t = e("./tool/guid"), n = e("./tool/util"), r = e("./mixin/Transformable"), i = e("./mixin/Eventful"), s = function (e) {
        e = e || {}, this.id = e.id || t();
    ...
    }, constructor: u}, r.merge(u.prototype, i.prototype, !0);
    ...
    var t = e("./Base"), n = e("./util/smoothSpline"), r = e("./util/smoothBezier"), i = e("./util/dashedLineTo"), s = function (e) {
        t.call(this, e)
    };
    ...
    return h.prototype = {setCalculable: function (e) {
        ...
        for (var a = 0, f = u.data.length; a < f; a++)i = u.data[a], !i.type || i.type !== "max" && i.type !== "min" && i.type !== "average" ? o = [this.getMarkCoord(e, i[0]), this.getMarkCoord(e, i[1])] : (o = this.getMarkCoord(e, i), u.data[a] = [l.clone(i), {}], u.data[a][0].name = i.name || i.type, u.data[a][0].value = o[3], o = o[2], i = [
            {},
            {}
        ]), u.data[a][0].x = i[0].x != null ? i[0].x : o[0][0], u.data[a][0].y = i[0].y != null ? i[0].y : o[0][1], u.data[a][1].x = i[1].x != null ? i[1].x : o[1][0], u.data[a][1].y = i[1].y != null ? i[1].y : o[1][1];
        ...
        var g = this.deepQuery(d, "symbolRotate"), y = this.deepMerge(d, "itemStyle.normal"), b = this.deepMerge(d, "itemStyle.emphasis"), w = y.borderWidth != null ? y.borderWidth : y.lineStyle && y.lineStyle.width;
        ...
        return o = new i({style: {pointList: s, color: f, strokeColor: f, shadowColor: d.shadowColor || f, shadowBlur: (d.shadowBlur != null ? d.shadowBlur : 8) * m, size: this.deepQuery(c, "symbolSize"), iconType: v, brushType: "fill", lineWidth: 1}, draggable: !1, hoverable: !1}), d.show && (o.effect = d), o
    ...
    return h.prototype = {type: o.COMPONENT_TYPE_TOOLBOX, _buildShape: function () {
        ...
        for (var m = 0; m < n; m++) {
            f = {type: "icon", zlevel: this._zlevelBase,
                style: {x: i, y: o, width: u, height: u, iconType: this._iconList[m], lineWidth: 1, strokeColor: this._featureColor[this._iconList[m]] || l[m % l.length], brushType: "stroke"},
                highlightStyle: {lineWidth: 1, text: t.showTitle ? this._featureTitle[this._iconList[m]] : undefined,
                    textFont: c, textPosition: h, strokeColor: this._featureColor[this._iconList[m]] || l[m % l.length]}, hoverable: !0,
                clickable: !0}, this._featureIcon[this._iconList[m]] && (f.style.image = this._featureIcon[this._iconList[m]].replace(new RegExp("^images:\\/\\/"), ""),
                f.style.opacity = .8, f.highlightStyle.opacity = 1, f.type = "image"),
                t.orient === "horizontal" && (m === 0 && p === "left" && (f.highlightStyle.textPosition = "specific",
                    f.highlightStyle.textAlign = p, f.highlightStyle.textBaseline = d, f.highlightStyle.textX = i,
                    f.highlightStyle.textY = d === "top" ? o + u + 10 : o - 10), m === n - 1 && p === "right" && (f.highlightStyle.textPosition = "specific",
                f.highlightStyle.textAlign = p, f.highlightStyle.textBaseline = d, f.highlightStyle.textX = i + u, f.highlightStyle.textY = d === "top" ? o + u + 10 : o - 10));
            switch (this._iconList[m]) {
                ...
                default:
                    //判断自定义工具条
                    if(!this._iconList[m].match("Chart")){
                        if(f.style.width==16){
                            f.style.width=20;
                            f.style.height=20;
                        }
        ...
        t != "png" && t != "jpeg" && (t = "png");
        var n;
        this.myChart.isConnected() ? n = this.myChart.getConnectedDataURL(t) : n = this.zr.toDataURL("images/" + t, this.option.backgroundColor && this.option.backgroundColor.replace(" ", "") === "rgba(0,0,0,0)" ? "#fff" : this.option.backgroundColor);
        ...
        var a = e.dataZoom;
        if (a && a.show) {
            var f = a.start != null && a.start >= 0 && a.start <= 100 ? a.start : 0, h = a.end != null && a.end >= 0 && a.end <= 100 ? a.end : 100;
    ...
    return d.prototype = {type: o.COMPONENT_TYPE_TOOLTIP, _gCssText: "position:absolute;display:block;border-style:solid;white-space:nowrap;", _style: function (e) {
        ...
        if (r.length > 0) {
            ...
            for (var l = 0, c = r.length; l < c; l++) {
                ...
                for (var v = 0, m = h.length; v < m; v++) {
                    ...
                    p = p != null ? p : {name: "", value: {dataIndex: "-"}}, d.push([r[l].name || "", p.name, p.value[t].value != null ? p.value[t].value : p.value[t], a])
                }
            }
        ...
        if (c) {
            ...
            y != null && b != null && (this._event = {zrenderX: y, zrenderY: b}, this.zr.addHoverShape(this._curTarget), this.zr.refreshHover(), this._showItemTrigger())
        }
    }, hideTip: function () {
        this._hide()
    }, refresh: function (e) {
    ...
    l.prototype = {type: u.COMPONENT_TYPE_LEGEND, _buildShape: function () {
        ...
        if (s.match("image")) {
            var f = s.replace(new RegExp("^images:\\/\\/"), "");
            s = "image"
        }
        switch (s) {
            case"line":
    ...
    function f(e, n, r, i, u) {
        ...
        a._onclick = function (e) {
            ...
            a.myChart.setOption(t, e.notMerge), a.messageCenter.dispatch(s.EVENT.TIMELINE_CHANGED, null, {currentIndex: a.currentIndex, data: e.data[a.currentIndex].name != null ? e.data[a.currentIndex].name : e.data[a.currentIndex]}, a.myChart)
        }, a._onFrame = function () {
    ...
    function l(e, t) {
        ...
        if (a === "last")e.moveTo(i + o - 2, s + u / 3), e.lineTo(i + o - 2, s), e.lineTo(i + 2, s + u / 2), e.lineTo(i + o - 2, s + u), e.lineTo(i + o - 2, s + u / 3 * 2), e.moveTo(i, s), e.lineTo(i, s); else if (a === "next")e.moveTo(i + 2, s + u / 3), e.lineTo(i + 2, s), e.lineTo(i + o - 2, s + u / 2), e.lineTo(i + 2, s + u), e.lineTo(i + 2, s + u / 3 * 2), e.moveTo(i, s), e.lineTo(i, s); else if (a === "play")if (t.status === "stop")e.moveTo(i + 2, s), e.lineTo(i + o - 2, s + u / 2), e.lineTo(i + 2, s + u), e.lineTo(i + 2, s); else {
            ...
            var l = "";
            l = a.replace(new RegExp("^images:\\/\\/"), ""), a = r.prototype.iconLibrary.image, a(e, {x: i, y: s, width: o, height: u, image: l})
        }
    }
    ...
    return f.prototype = {type: s.COMPONENT_TYPE_TIMELINE, _buildShape: function () {
        ...
        return e.y != null ? (a = this.parsePercent(e.y, o), f = a + u) : (f = o - this.parsePercent(e.y2, o), a = f - u), {x: r + t[3], y: a + t[0], x2: i - t[1], y2: f - t[2], width: s - t[1] - t[3], height: u - t[0] - t[2]}
    }, _getReformedLabel: function (e) {
        var t = this.timelineOption, n = t.data[e].name != null ? t.data[e].name : t.data[e], r = t.data[e].formatter || t.label.formatter;
    ...
    var t = e("./Base"), n = e("../tool/util"), r = e("../tool/color"), i = e("../tool/area"), s = e("../shape/Sector");
    return n.inherits(o, t), o.prototype._start = function (e, t) {
        var o = n.merge(this.options, {textStyle: {color: "#fff", textAlign: "start"}, backgroundColor: "rgba(0, 0, 0, 0.8)"}), u = this.createTextShape(o.textStyle), a = 10, f = i.getTextWidth(u.highlightStyle.text, u.highlightStyle.textFont), l = i.getTextHeight(u.highlightStyle.text, u.highlightStyle.textFont), c = n.merge(this.options.effect || {}, {r0: 9, r: 15, n: 18, color: "#fff", timeInterval: 100}), h = this.getLocation(this.options.textStyle, f + a + c.r * 2, Math.max(c.r * 2, l));
        c.x = h.x + c.r, c.y = u.highlightStyle.y = h.y + h.height / 2, u.highlightStyle.x = c.x + c.r + a;
        var p = this.createBackgroundShape(o.backgroundColor), d = c.n, v = c.x, m = c.y, g = c.r0, y = c.r, b = c.color, w = [], E = Math.round(180 / d);
        for (var S = 0; S < d; S++)w[S] = new s({highlightStyle: {x: v, y: m, r0: g, r: y, startAngle: E * S * 2, endAngle: E * S * 2 + E, color: r.alpha(b, (S + 1) / d), brushType: "fill"}});
        var x = [0, v, m];
        return setInterval(function () {
            e(p), x[0] -= .3;
    ...
    var t = e("./Base"), n = e("../tool/util"), r = e("../tool/area"), i = e("../shape/Ring"), s = e("../shape/Droplet"), o = e("../shape/Circle");
    return n.inherits(u, t), u.prototype._start = function (e, t) {
        var u = n.merge(this.options, {textStyle: {color: "#888", textAlign: "start"}, backgroundColor: "rgba(250, 250, 250, 0.8)"}), a = this.createTextShape(u.textStyle), f = 10, l = r.getTextWidth(a.highlightStyle.text, a.highlightStyle.textFont), c = r.getTextHeight(a.highlightStyle.text, a.highlightStyle.textFont), h = n.merge(this.options.effect || {}, {r: 18, colorIn: "#fff", colorOut: "#555", colorWhirl: "#6cf", timeInterval: 50}), p = this.getLocation(this.options.textStyle, l + f + h.r * 2, Math.max(h.r * 2, c));
        h.x = p.x + h.r, h.y = a.highlightStyle.y = p.y + p.height / 2, a.highlightStyle.x = h.x + h.r + f;
        var d = this.createBackgroundShape(u.backgroundColor), v = new s({highlightStyle: {a: Math.round(h.r / 2), b: Math.round(h.r - h.r / 6), brushType: "fill", color: h.colorWhirl}}), m = new o({highlightStyle: {r: Math.round(h.r / 6), brushType: "fill", color: h.colorIn}}), g = new i({highlightStyle: {r0: Math.round(h.r - h.r / 3), r: h.r, brushType: "fill", color: h.colorOut}}), y = [0, h.x, h.y];
    ...
    var c = e("zrender/config").EVENT, h = ["CLICK", "DBLCLICK", "MOUSEOVER", "MOUSEOUT", "DRAGSTART", "DRAGEND", "DRAGENTER", "DRAGOVER", "DRAGLEAVE", "DROP"];
    return l.prototype = {_init: function () {
        ...
        if (t) {
            ...
            return i = r != -1 && this.component.dataZoom ? this.component.dataZoom.getRealDataIndex(r, i) : i, {seriesIndex: r, seriesName: (n.get(t, "series") || {}).name, dataIndex: i, data: n.get(t, "data"), name: n.get(t, "name"), value: n.get(t, "value"), special: n.get(t, "special")}
        }
        return
    }, _render: function (n) {
        ...
        var a = ["title", "legend", "tooltip", "dataRange", "roamController", "grid", "dataZoom", "xAxis", "yAxis", "polar"], f, l, c;
        ...
        return i && i.replace(" ", "") === "rgba(0,0,0,0)" && (i = "#fff"), this._zr.toDataURL("images/" + e, i)
    }, getImage: function (e) {
        ...
        var p = l.toDataURL("images/png", h);
        return setTimeout(function () {
    ...
    var t = e("../component/base"), n = e("./base"), r = e("../util/shape/GaugePointer"), i = e("zrender/shape/Text"), s = e("zrender/shape/Line"), o = e("zrender/shape/Rectangle"), u = e("zrender/shape/Circle"), a = e("zrender/shape/Sector"), f = e("../config"), l = e("../util/ecData"), c = e("../util/accMath"), h = e("zrender/tool/util");
    return p.prototype = {type: f.CHART_TYPE_GAUGE, _buildShape: function () {
        var e = this.series;
        this._paramsMap = {};
    ...
    return h.prototype = {type: o.CHART_TYPE_FUNNEL, _buildShape: function () {
        ...
        var u;
        return t.height == null ? u = r - s - this.parsePercent(t.y2, r) : u = this.parsePercent(t.height, r), {x: i, y: s, width: o, height: u, centerX: i + o / 2}
    }, _mapData: function (e) {
        function s(e, t) {
        ...
        var f = this.series[e], c = f.data[t], h = [c, f], p = this.deepMerge(h, "itemStyle.normal") || {}, d = this.deepMerge(h, "itemStyle.emphasis") || {}, v = this.getItemStyleColor(p.color, e, t, c) || n, m = this.getItemStyleColor(d.color, e, t, c) || (typeof v == "string" ? l.lift(v, -0.2) : v), g = {zlevel: this._zlevelBase, clickable: this.deepQuery(h, "clickable"), style: {pointList: [
            [r, i],
            [r + o, i],
            [r + o - (o - u) / 2, i + a],
            [r + (o - u) / 2, i + a]
    ...
    return u.prototype = {type: s.COMPONENT_TYPE_DATAZOOM, _buildShape: function () {
        ...
        this._zoom.scatterMap[t].x = s.getAxis(u).getExtremum(), s.dispose(), i = o.clone(this.option.yAxis), i instanceof Array ? (i[0].type = "value", i[0].scale = !0, i[1] && (i[1].type = "value", i[1].boundary = [0, 0])) : (i.type = "value", i.scale = !0, i.boundary = [0, 0]), s = new r(this.ecTheme, null, !1, {yAxis: i, series: this.option.series}, this, "yAxis"), u = this.option.series[t].yAxisIndex || 0, this._zoom.scatterMap[t].y = s.getAxis(u).getExtremum(), s.dispose()
    }, _buildBackground: function () {
    ...
    return u.prototype = {type: i.CHART_TYPE_K, _buildShape: function () {
        ...
        var g = this.series, y = {zlevel: this._zlevelBase, clickable: this.deepQuery([g[e].data[t], g[e]], "clickable"), style: {x: i, y: [u, a, f, l], width: o, color: c, strokeColor: p, lineWidth: h, brushType: "both"}, highlightStyle: {color: d, strokeColor: m, lineWidth: v}, _seriesIndex: e};
    ...
    return l.prototype = {type: u.COMPONENT_TYPE_POLAR, _buildShape: function () {
        ...
        var t = this.polar[e], r = this.deepQuery(this._queryTarget, "indicator"), i = t.__ecIndicator, s, o, u, f, l = this.deepQuery(this._queryTarget, "splitNumber"), c = this.getCenter(e), o, h, p, d, v, m = this.deepQuery(this._queryTarget, "precision"), g;
        for (var y = 0; y < r.length; y++) {
            ...
            if (s.show) {
                ...
                if (!h)return;
                for (var b = 1; b <= l; b += g + 1)f = a.merge({}, u), p = b * (h.max - h.min) / l + h.min, m && (p = p.toFixed(m)), f.text = this.numAddCommas(p), f.x = b * o[0] / l + Math.cos(d) * v + c[0], f.y = b * o[1] / l + Math.sin(d) * v + c[1], this.shapeList.push(new n({zlevel: this._zlevelBase, style: f, draggable: !1, hoverable: !1}))
            }
        }
    ...
    return a.prototype = {type: i.CHART_TYPE_RADAR, _buildShape: function () {
        ...
        var f = this.series, l = [n, this.serie], c = this.getItemStyleColor(this.deepQuery(l, "itemStyle.normal.color"), i, o, n), h = this.deepQuery(l, "itemStyle.normal.lineStyle.width"), p = this.deepQuery(l, "itemStyle.normal.lineStyle.type"), d = this.deepQuery(l, "itemStyle.normal.areaStyle.color"), v = this.deepQuery(l, "itemStyle.normal.areaStyle"), m = {zlevel: this._zlevelBase, style: {pointList: e, brushType: v ? "both" : "stroke", color: d || c || (typeof t == "string" ? u.alpha(t, .5) : t), strokeColor: c || t, lineWidth: h, lineType: p}, highlightStyle: {brushType: this.deepQuery(l, "itemStyle.emphasis.areaStyle") || v ? "both" : "stroke", color: this.deepQuery(l, "itemStyle.emphasis.areaStyle.color") || d || c || (typeof t == "string" ? u.alpha(t, .5) : t), strokeColor: this.getItemStyleColor(this.deepQuery(l, "itemStyle.emphasis.color"), i, o, n) || c || t, lineWidth: this.deepQuery(l, "itemStyle.emphasis.lineStyle.width") || h, lineType: this.deepQuery(l, "itemStyle.emphasis.lineStyle.type") || p}};
    ...
    var t = e("zrender/shape/Base"), n = e("zrender/shape/util/PathProxy"), r = e("zrender/tool/util"), i = e("zrender/tool/area");
    return s.prototype = {type: "chord", buildPath: function (e, t) {
        var n = this._pathProxy;
        n.begin(e);
        var r = Math.PI * 2, i = t.x, s = t.y, o = t.r, u = t.source0 / 180 * Math.PI, a = t.source1 / 180 * Math.PI, f = t.target0 / 180 * Math.PI, l = t.target1 / 180 * Math.PI, c = i + Math.cos(r - u) * o, h = s - Math.sin(r - u) * o, p = i + Math.cos(r - a) * o, d = s - Math.sin(r - a) * o, v = i + Math.cos(r - f) * o, m = s - Math.sin(r - f) * o, g = i + Math.cos(r - l) * o, y = s - Math.sin(r - l) * o;
...
}), define("echarts/chart/chord", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Sector", "../util/shape/Ribbon", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/vector", "../util/ndarray", "../chart"], function (e) {
    function p(e, r, i, s, o) {
        t.call(this, e, r, i, s, o), n.call(this), this.refresh(s)
    }

    var t = e("../component/base"), n = e("./base"), r = e("zrender/shape/Text"), i = e("zrender/shape/Line"), s = e("zrender/shape/Sector"), o = e("../util/shape/Ribbon"), u = e("../config"), a = e("../util/ecData"), f = e("zrender/tool/util"), l = e("zrender/tool/vector"), c = e("../util/ndarray"), h = window.devicePixelRatio || 1;
    ...
    s.prototype.beforeUpdate = function () {
        ...
        for (var i = 0; i < n; i++) {
            var s = e[i * 2], o = e[i * 2 + 1], a = this.nodes[s], f = this.nodes[o];
            if (!a || !f)continue;
        ...
        for (var t = 0; t < e; t++) {
            var o = this.nodes[t];
            if (this.barnesHutOptimize)this.applyRegionToNodeRepulsion(this._rootRegion, o); else for (var u = t + 1; u < e; u++) {
                var a = this.nodes[u];
        ...
        var f = n.create();
        for (var t = 0; t < e; t++) {
            var s = this.nodes[t], l = s.speed;
            n.scale(s.force, s.force, 1 / 30);
            var c = n.len(s.force) + .1, h = Math.min(c, 500) / c;
            ...
            var v = n.len(l), h = Math.min(v, 100) / (v + .1);
    ...
    var t = e("./forceLayoutWorker"), n = e("zrender/tool/vector"), r = window.requestAnimationFrame || window.msRequestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function (e) {
        setTimeout(e, 16)
    ...
    return a.prototype.updateConfig = function () {
        var e = this.width, t = this.height, n = Math.min(e, t), r = {center: this.center, width: this.ratioScaling ? e : n, height: this.ratioScaling ? t : n, scaling: this.scaling || 1, gravity: this.gravity || 1, barnesHutOptimize: this.large};
        if (this._layoutWorker)this._layoutWorker.postMessage({cmd: "updateConfig", config: r}); else for (var i in r)this._layout[i] = r[i]
        ...
        this._token = o(), this._layoutWorker ? this._layoutWorker.postMessage({cmd: "init", nodesPosition: a, nodesMass: f, nodesSize: l, edges: p, edgesWeight: d, token: this._token}) : (this._layout.setToken(this._token), this._layout.initNodes(a, f, l), this._layout.initEdges(p, d)), this.updateConfig()
        ...
        if (this._layoutWorker) {
            ...
            this._layoutWorker.postMessage(s.buffer, [s.buffer]), this._layoutWorker.postMessage({cmd: "update", steps: e, temperature: this.temperature, coolDown: this.coolDown});
...
}), define("echarts/chart/force", ["require", "../component/base", "./base", "../data/Graph", "../layout/Force", "zrender/shape/Line", "zrender/shape/Image", "../util/shape/Icon", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/vector", "../chart"], function (e) {
    ...
    var t = e("../component/base"), n = e("./base"), r = e("../data/Graph"), i = e("../layout/Force"), s = e("zrender/shape/Line"), o = e("zrender/shape/Image"), u = e("../util/shape/Icon"), a = e("../config"), f = e("../util/ecData"), l = e("zrender/tool/util"), c = e("zrender/config"), h = e("zrender/tool/vector");
    return p.prototype = {constructor: p, type: a.CHART_TYPE_FORCE, _init: function () {
        ...
        for (var u = 0; u < n; u++) {
            var a = t.nodes[u];
            a.layout = {radius: a.data.value || 1, mass: 0}, o = Math.max(a.data.value, o), s = Math.min(a.data.value, s)
        }
        var f = o - s;
        for (var u = 0; u < n; u++) {
            var a = t.nodes[u];
        ...
        for (var s = 0; s < r; s++) {
            var a = t.nodes[s], c = a.data, h = new u({style: {x: 0, y: 0}, clickable: this.query(e, "clickable"), highlightStyle: {}}), p = [], d = [], v = [];
            ...
            p.push(e), d.unshift(e.itemStyle.normal.nodeStyle), v.unshift(e.itemStyle.emphasis.nodeStyle), h.style.iconType = this.deepQuery(p, "symbol"), h.style.width = h.style.height = (this.deepQuery(p, "symbolSize") || 0) * 2, h.style.iconType.match("image") && (h.style.image = h.style.iconType.replace(new RegExp("^images:\\/\\/"), ""), h = new o({style: h.style, highlightStyle: h.highlightStyle, clickable: h.clickable}));
        ...
        for (var r = 0; r < n; r++) {
            var i = t.edges[r], o = i.data, a = i.node1, c = i.node2, h = new s({style: {xStart: 0, yStart: 0, xEnd: 0, yEnd: 0, lineWidth: 1}, clickable: this.query(e, "clickable"), highlightStyle: {}});
            l.merge(h.style, this.query(e, "itemStyle.normal.linkStyle"), !0), l.merge(h.highlightStyle, this.query(e, "itemStyle.emphasis.linkStyle"), !0), typeof o.itemStyle != "undefined" && (o.itemStyle.normal && l.merge(h.style, o.itemStyle.normal, !0), o.itemStyle.emphasis && l.merge(h.highlightStyle, o.itemStyle.emphasis, !0)), f.pack(h, e, 0, {source: a.data, target: c.data, weight: i.data.weight || 0}, i.rawIndex, a.name + " - " + c.name, i.data.weight || 0, !0), this.shapeList.push(h), this.zr.addShape(h), i.shape = h;
            if (e.linkSymbol && e.linkSymbol !== "none") {
                var p = new u({style: {x: -5, y: 0, width: e.linkSymbolSize[0], height: e.linkSymbolSize[1], iconType: e.linkSymbol, brushType: "fill", color: h.style.strokeColor, opacity: h.style.opacity, shadowBlur: h.style.shadowBlur, shadowColor: h.style.shadowColor, shadowOffsetX: h.style.shadowOffsetX, shadowOffsetY: h.style.shadowOffsetY}, highlightStyle: {brushType: "fill"}, position: [0, 0], rotation: 0});
    ...
    function c(e, t) {
        ...
        var f = "";
        a.match("image") && (f = a.replace(new RegExp("^images:\\/\\/"), ""), a = "image", n += Math.round((s - o) / 2) - 1, s = o += 2), a = i.prototype.iconLibrary[a];
        if (a) {
            var l = t.x, c = t.y;
    ...
    return l.prototype = {type: o.CHART_TYPE_LINE, _buildShape: function () {
        ...
        for (var w = 0, E = t; w < E; w++) {
            ...
            for (var S = 0, x = n.length; S < x; S++) {
                ...
                for (var T = 0, N = n[S].length; T < N; T++) {
                    s = n[S][T], o = i[s], y = o.data[w], b = y != null ? y.value != null ? y.value : y : "-", g[s] = g[s] || [], r[s] = r[s] || {min: Number.POSITIVE_INFINITY, max: Number.NEGATIVE_INFINITY, sum: 0, counter: 0, average: 0};
                    if (b === "-") {
        ...
        for (var c = e.length - 1; c >= 0; c--) {
            ...
            if (p.type === this.type && d != null) {
                var v = this._getBbox(h, i), m = this._sIndex2ColorMap[h], g = this.query(p, "itemStyle.normal.lineStyle.width"), y = this.query(p, "itemStyle.normal.lineStyle.type"), b = this.query(p, "itemStyle.normal.lineStyle.color"), w = this.getItemStyleColor(this.query(p, "itemStyle.normal.color"), h, -1), E = this.query(p, "itemStyle.normal.areaStyle") != null, S = this.query(p, "itemStyle.normal.areaStyle.color");
                for (var x = 0, T = d.length; x < T; x++) {
                    ...
                    var A = new r({zlevel: this._zlevelBase, style: {miterLimit: g, pointList: N, strokeColor: b || w || m, lineWidth: g, lineType: y, smooth: this._getSmooth(p.smooth), smoothConstraint: v, shadowColor: this.query(p, "itemStyle.normal.lineStyle.shadowColor"), shadowBlur: this.query(p, "itemStyle.normal.lineStyle.shadowBlur"), shadowOffsetX: this.query(p, "itemStyle.normal.lineStyle.shadowOffsetX"), shadowOffsetY: this.query(p, "itemStyle.normal.lineStyle.shadowOffsetY")}, hoverable: !1, _main: !0, _seriesIndex: h, _orient: i});
                    u.pack(A, o[h], h, 0, x, o[h].name), this.shapeList.push(A);
                    if (E) {
                        var O = new s({zlevel: this._zlevelBase, style: {miterLimit: g, pointList: a.clone(N).concat([
                            [N[N.length - 1][4], N[N.length - 1][5]],
                            [N[0][4], N[0][5]]
                        ]), brushType: "fill", smooth: this._getSmooth(p.smooth), smoothConstraint: v, color: S ? S : f.alpha(m, .5)}, hoverable: !1, _main: !0, _seriesIndex: h, _orient: i});
    ...
    return a.prototype = {type: i.CHART_TYPE_BAR, _buildShape: function () {
        ...
        for (var A = 0, O = e; A < O; A++) {
            ...
            for (var M = 0, _ = t.length; M < _; M++) {
                ...
                for (var D = 0, P = t[M].length; D < P; D++) {
                    o = t[M][D], u = s[o], k = u.data[A], L = k != null ? k.value != null ? k.value : k : "-", i[o] = i[o] || {min: Number.POSITIVE_INFINITY, max: Number.NEGATIVE_INFINITY, sum: 0, counter: 0, average: 0};
                    if (L === "-")continue;
        ...
        var l = this.series, c, h = l[e], p = h.data[t], d = this._sIndex2colorMap[e], v = [p, h], m = this.deepQuery(v, "itemStyle.normal.color") || d, g = this.deepQuery(v, "itemStyle.emphasis.color"), y = this.deepMerge(v, "itemStyle.normal"), b = y.barBorderWidth, w = this.deepMerge(v, "itemStyle.emphasis");
